...
// Definição das palavras-chave, cada uma vai ter uma string e um apontamento
// para uma próxima, caso existir
...
// Definição do meu podcast, vai possuir um id, uma string nome(podcast), uma
// string nome(episódio) e um numero do episódio
